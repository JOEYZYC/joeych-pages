...
export const UI = {
  zh: {
    ...
    routeIntros: {
      ...
      projects: { overline: "工程实践", title: "项目介绍", summary: "按项目类别、项目名称与荣誉筛选，查看完整的工程实践、贡献与图文证据。" },
  ...
  en: {
    ...
    routeIntros: {
      ...
      projects: { overline: "Engineering Work", title: "Projects", summary: "Filter by project category, name, and honor to inspect complete engineering work, contributions, and supporting figures." },
