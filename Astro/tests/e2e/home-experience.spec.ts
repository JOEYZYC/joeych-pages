...
const homeRoutes = [
  {
    ...
    heading: "你好，我叫张易成",
    portraitName: "张易成",
    summary: "我是一名电子信息工程本科毕业生，关注嵌入式系统、无线感知与智能硬件。我喜欢把想法落实为可以运行、可以验证的软硬件作品。",
  ...
  },
  {
    ...
    heading: "Hi, I'm Joey.",
    portraitName: "JOEYCH",
    summary: "I am an Electronic & Information Engineering graduate, with interests in embedded systems, wireless sensing, and intelligent hardware. I enjoy turning ideas into practical hardware-software projects.",
